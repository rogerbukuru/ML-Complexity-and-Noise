...
# Function to normalize the target function
#normalize = function(func) {
#  mean_func = mean(func)
#  sd_func = sd(func)
#  return((func - mean_func) / sd_func)
#}
...
func=rLegfunc(x,q)
#func_normalized = normalize(func_1)  # Normalize the target function
...
results_normalized = apply(results, 2, normalize)

# Create a color map of the relative performance
image.plot(N_vals, sigma_vals, results_normalized, xlab = "N", ylab = "sigma", main = "Relative Performance (H10 - H2)")
...
results_normalized = scale(results, center = TRUE, scale=TRUE)
image.plot(N_vals, Qf_vals, results_normalized, xlab = "N", ylab = "Qf", main = "Relative Performance (H10 - H2)")
